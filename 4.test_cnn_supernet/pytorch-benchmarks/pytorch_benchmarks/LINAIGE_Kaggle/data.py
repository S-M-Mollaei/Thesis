...
def get_data(win_size:int, confindence:str, remove_frame:bool, classification:bool, session_number:int=None, test_split:float=None, data_dir:str=None) -> Tuple[Dataset, ...]:
